...
from api.schemas.review_schemas import ReviewCreateRequest, ReviewCreateResponse, Review, ReviewUpdateRequest
...
@router.post("/", status_code=201, response_model=ReviewCreateResponse)
