...
def get_test_data():
    return {
        ...
        'campsite_contact': [
            ...
            CampsiteContact(campsite_contact_id=3, campsite_id=3, campsite_contact_name="Jack Doe",
        ...
        'user': [
            ...
            User(username="ForestFanatic", hashed_password="secure123", user_firstname="Clara",
