...
def get_dev_data():
    return {
        ...
        'user': [
            User(username="Admin", hashed_password="secure123", user_firstname="All of", user_lastname="Us",
            ...
            User(username="VigorousCamel", hashed_password="secure123", user_firstname="Dan", user_lastname="Rivers",
                 user_email="dan.raider@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User(username="MeadowSinger", hashed_password="secure123", user_firstname="Eva", user_lastname="Song",
                 user_email="eva.singer@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User(username="CampfireStoryteller", hashed_password="secure123", user_firstname="Frank", user_lastname="Tales",
                 user_email="frank.tales@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User(username="TrailBlazer", hashed_password="secure123", user_firstname="Grace", user_lastname="Pathfinder",
                 user_email="grace.blazer@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User(username="LakesideLounger", hashed_password="secure123", user_firstname="Harry", user_lastname="Waters",
