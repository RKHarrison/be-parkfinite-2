    ...
    return {
        ...
        'campsite': [
            Campsite(campsite_name="Tranquil Trails Campsite", category_id=1, campsite_longitude=-1.54322, campsite_latitude=53.45645, parking_cost=12, facilities_cost=25,
                     description="Tranquil Trails Campsite offers a serene setting amidst lush greenery, ideal for a peaceful retreat.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Heather Heights Campsite", category_id=2, campsite_longitude=-1.87654, campsite_latitude=53.54321, parking_cost=14, facilities_cost=27,
                     description="Nestled on gentle slopes, Heather Heights provides stunning views and vibrant sunsets.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Riverside Retreat Campsite", category_id=3, campsite_longitude=-1.81234, campsite_latitude=53.123456, parking_cost=13, facilities_cost=26,
                     description="Riverside Retreat offers prime access to river adventures in a picturesque setting.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Summit Sanctuary Campsite", category_id=4, campsite_longitude=-1.90013, campsite_latitude=53.289111, parking_cost=15, facilities_cost=29,
                     description="Summit Sanctuary sits atop the peaks, offering breathtaking views and crisp mountain air.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Meadowlands Escape Campsite", category_id=5, campsite_longitude=-1.2345, campsite_latitude=53.323, parking_cost=11, facilities_cost=23,
                     description="Meadowlands Escape is perfect for nature lovers seeking a calm, floral setting.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Peak Paradise", category_id=1, campsite_longitude=-1.8374, campsite_latitude=53.259082, parking_cost=15.00, facilities_cost=25.00,
                     description="A tranquil spot in the heart of the Peak District with beautiful mountain views.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Lake Escape", category_id=2, campsite_longitude=-1.8399, campsite_latitude=53.260082, parking_cost=10.00, facilities_cost=20.00,
                     description="Perfect place next to the lake with plenty of fishing.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Valley View Haven", category_id=3, campsite_longitude=-1.84567, campsite_latitude=53.37201, parking_cost=16, facilities_cost=30,
                     description="Valley View Haven offers panoramic valley views, perfect for those seeking tranquility and natural beauty.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Highland Hideaway", category_id=4, campsite_longitude=-1.89654, campsite_latitude=53.34029, parking_cost=14, facilities_cost=28,
                     description="Highland Hideaway is nestled among highland hills, ideal for explorers and adventurers alike.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Blue Brook Camp", category_id=5, campsite_longitude=-1.93012, campsite_latitude=53.35834, parking_cost=13, facilities_cost=27,
                     description="Blue Brook Camp lies next to a gentle stream, offering a peaceful setting for relaxation and reflection.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Eagle's Crest Campsite", category_id=1, campsite_longitude=-1.87045, campsite_latitude=53.26478, parking_cost=17, facilities_cost=33,
                     description="Eagle's Crest Campsite provides a high elevation camping experience with spectacular mountain vistas.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Misty Meadows Campsite", category_id=2, campsite_longitude=-1.88855, campsite_latitude=53.27563, parking_cost=15, facilities_cost=25,
                     description="Misty Meadows Campsite is surrounded by lush, fog-laden meadows offering a mystical camping experience.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Sunset Ridge Camp", category_id=1, campsite_longitude=-1.90721, campsite_latitude=53.36910, parking_cost=18, facilities_cost=32,
                     description="Sunset Ridge Camp offers unforgettable sunset views from atop a quiet ridge, ideal for photographers and nature lovers.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Starlight Glade Campsite", category_id=2, campsite_longitude=-1.85102, campsite_latitude=53.35476, parking_cost=15, facilities_cost=24,
                     description="Starlight Glade Campsite is tucked away in a secluded glade, perfect for stargazing and quiet nights by the fire.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Clearwater Cove Campsite", category_id=3, campsite_longitude=-1.93933, campsite_latitude=53.36588, parking_cost=16, facilities_cost=29,
                     description="Clearwater Cove Campsite sits beside crystal clear waters, providing ample opportunities for swimming and canoeing.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Old Pine Retreat", category_id=4, campsite_longitude=-1.92378, campsite_latitude=53.37811, parking_cost=14, facilities_cost=27,
                     description="Old Pine Retreat offers a break from the hustle with its ancient pine groves and quiet paths.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Golden Meadow Campsite", category_id=5, campsite_longitude=-1.89210, campsite_latitude=53.36179, parking_cost=13, facilities_cost=26,
                     description="Golden Meadow Campsite features expansive meadows with golden hues, making it a joyful place for families and groups.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Craggy Peak Site", category_id=1, campsite_longitude=-1.88432, campsite_latitude=53.35100, parking_cost=17, facilities_cost=31,
                     description="Craggy Peak Site offers adventurous souls a rugged landscape with spectacular cliffside views.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Forest Whisper Camp", category_id=2, campsite_longitude=-1.85544, campsite_latitude=53.34702, parking_cost=19, facilities_cost=35,
                     description="Forest Whisper Camp is enveloped in a dense forest where the only sound is the rustling of leaves.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Bluebell Woodland Camp", category_id=3, campsite_longitude=-1.87760, campsite_latitude=53.36290, parking_cost=14, facilities_cost=28,
                     description="Bluebell Woodland Camp is blanketed with bluebells in the spring, offering a magical camping experience.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Lakeside Serenity Camp", category_id=4, campsite_longitude=-1.86011, campsite_latitude=53.37333, parking_cost=16, facilities_cost=30,
                     description="Lakeside Serenity Camp is nestled beside a tranquil lake, perfect for peaceful water activities.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Hilltop Haven Campsite", category_id=5, campsite_longitude=-1.84233, campsite_latitude=53.35922, parking_cost=15, facilities_cost=25,
                     description="Hilltop Haven Campsite sits on a gentle hill, offering panoramic views of the valley below.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="River Bend Campsite", category_id=1, campsite_longitude=-1.90044, campsite_latitude=53.36825, parking_cost=18, facilities_cost=34,
                     description="River Bend Campsite is a favorite for those who love fishing and riverside picnics.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Orchard Retreat Camp", category_id=2, campsite_longitude=-1.91977, campsite_latitude=53.37529, parking_cost=17, facilities_cost=32,
                     description="Orchard Retreat Camp is surrounded by historic orchards, offering a sweet and fragrant atmosphere.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Grove Corner Campground", category_id=3, campsite_longitude=-1.86192, campsite_latitude=53.35548, parking_cost=15, facilities_cost=29,
                     description="Grove Corner Campground is ideal for those who seek solitude in a grove of ancient trees.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Falcon Ridge Camp", category_id=4, campsite_longitude=-1.87911, campsite_latitude=53.34419, parking_cost=16, facilities_cost=27,
                     description="Falcon Ridge Camp offers thrilling heights and the chance to see falcons in their natural habitat.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Whispering Pines Campsite", category_id=5, campsite_longitude=-1.86520, campsite_latitude=53.35077, parking_cost=14, facilities_cost=26,
                     description="Whispering Pines Campsite is where the pines murmur with the breeze, a place for rest and rejuvenation.", date_added=date_stamp(), user_account_id=1, approved=True),
            ...
            Campsite(campsite_name="Seaside Sanctuary Campsite", category_id=2, campsite_longitude=-4.1741, campsite_latitude=52.4160, parking_cost=10, facilities_cost=20,
                     description="Seaside Sanctuary offers stunning ocean views and easy beach access, perfect for relaxation.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Castle View Campsite", category_id=1, campsite_longitude=-3.2028, campsite_latitude=55.9486, parking_cost=15, facilities_cost=25,
                     description="Enjoy the majestic sight of Edinburgh Castle from your tent at Castle View Campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Dartmoor Wild Camp", category_id=3, campsite_longitude=-3.8985, campsite_latitude=50.5719, parking_cost=8, facilities_cost=16,
                     description="Experience the untamed wilderness of Dartmoor with our exclusive wild camping spots.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Lakeside Retreat Camp", category_id=5, campsite_longitude=-3.0762, campsite_latitude=54.4609, parking_cost=12, facilities_cost=24,
                     description="Nestled beside a tranquil lake, Lakeside Retreat offers a peaceful setting with abundant fishing.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Peak District Haven", category_id=1, campsite_longitude=-1.8160, campsite_latitude=53.2370, parking_cost=17, facilities_cost=30,
                     description="Set in the heart of the Peak District, this campsite offers breathtaking landscapes and numerous hiking trails.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Forest Glade Campsite", category_id=4, campsite_longitude=-2.3336, campsite_latitude=51.8576, parking_cost=14, facilities_cost=28,
                     description="Forest Glade Campsite is tucked away in a lush forest, offering a serene and shaded camping experience.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Highland Stream Campsite", category_id=2, campsite_longitude=-4.7130, campsite_latitude=57.4778, parking_cost=15, facilities_cost=25,
                     description="Enjoy the sounds of a babbling brook and the fresh Highland air at our exclusive streamside campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Cornish Coastline Camp", category_id=3, campsite_longitude=-5.2364, campsite_latitude=50.1188, parking_cost=13, facilities_cost=26,
                     description="Overlooking the dramatic cliffs of Cornwall, our campsite offers stunning sea views and private beach access.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Yorkshire Dales Retreat", category_id=4, campsite_longitude=-2.0774, campsite_latitude=54.2812, parking_cost=12, facilities_cost=23,
                     description="Set in the rolling hills of the Yorkshire Dales, perfect for walkers and cyclists seeking a quiet getaway.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Gower Peninsula Paradise", category_id=1, campsite_longitude=-4.2864, campsite_latitude=51.6134, parking_cost=16, facilities_cost=32,
                     description="Located on the stunning Gower Peninsula, this campsite offers scenic views and coastal walks.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Norfolk Broads Basecamp", category_id=5, campsite_longitude=1.56, campsite_latitude=52.62, parking_cost=11, facilities_cost=22,
                     description="Ideal for water sports enthusiasts and bird watchers, located in the heart of the Norfolk Broads.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Snowdonia Sky Camp", category_id=2, campsite_longitude=-4.0000, campsite_latitude=52.9000, parking_cost=14, facilities_cost=27,
                     description="Camp under the stars at Snowdonia Sky Camp, with spectacular mountain views and challenging treks.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Loch Ness Lookout", category_id=3, campsite_longitude=-4.4177, campsite_latitude=57.3229, parking_cost=15, facilities_cost=30,
                     description="Monster spotting and more at our Loch Ness site, with unbeatable views of the famous loch.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Brecon Beacons Base", category_id=4, campsite_longitude=-3.4312, campsite_latitude=51.8817, parking_cost=12, facilities_cost=24,
                     description="Nestled in the heart of the Brecon Beacons, our campsite is a hiker's heaven.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Isle of Skye Sanctuary", category_id=5, campsite_longitude=-6.2116, campsite_latitude=57.5359, parking_cost=17, facilities_cost=34,
                     description="Explore the mystic landscapes of Skye from our secluded campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="New Forest Nook", category_id=1, campsite_longitude=-1.5731, campsite_latitude=50.8755, parking_cost=13, facilities_cost=26,
                     description="Escape to a woodland wonderland in the New Forest with easy access to walking paths.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Pembrokeshire Coastal Corner", category_id=2, campsite_longitude=-4.6999, campsite_latitude=51.6735, parking_cost=15, facilities_cost=30,
                     description="Perched on the cliffs of Pembrokeshire, our campsite offers spectacular coastal views.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Lake District Lakeshore", category_id=3, campsite_longitude=-3.0736, campsite_latitude=54.4604, parking_cost=14, facilities_cost=28,
                     description="Stay by the lakeside in the stunning Lake District for boating, fishing, and relaxation.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Cotswolds Country Camp", category_id=4, campsite_longitude=-1.8378, campsite_latitude=51.7457, parking_cost=16, facilities_cost=32,
                     description="Enjoy the rolling hills of the Cotswolds at our charming country campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Isle of Arran Adventure", category_id=5, campsite_longitude=-5.0474, campsite_latitude=55.5762, parking_cost=10, facilities_cost=20,
                     description="Adventure awaits on the Isle of Arran, with stunning landscapes and wildlife.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Jurassic Coast Gem", category_id=1, campsite_longitude=-2.6000, campsite_latitude=50.7000, parking_cost=18, facilities_cost=36,
                     description="Step back in time with our campsite on the Jurassic Coast, famous for fossils and coastal hikes.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Welsh Valleys View", category_id=2, campsite_longitude=-3.4333, campsite_latitude=51.7000, parking_cost=11, facilities_cost=22,
                     description="Located in the heart of the Welsh Valleys, our campsite offers stunning scenery and peaceful surroundings.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Shetland Isles Shelter", category_id=3, campsite_longitude=-1.2650, campsite_latitude=60.1525, parking_cost=16, facilities_cost=32,
                     description="Experience the unique culture and wildlife of the Shetland Isles from our remote campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Northumberland National Park Niche", category_id=4, campsite_longitude=-2.5477, campsite_latitude=55.3174, parking_cost=13, facilities_cost=27,
                     description="Surrounded by the rugged terrain of Northumberland National Park, our site is ideal for outdoor enthusiasts.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Thames Riverside Rest", category_id=5, campsite_longitude=-0.9728, campsite_latitude=51.5372, parking_cost=15, facilities_cost=30,
                     description="Relax by the River Thames at our picturesque riverside campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Chiltern Hills Hideaway", category_id=1, campsite_longitude=-0.6667, campsite_latitude=51.6667, parking_cost=14, facilities_cost=28,
                     description="Hidden in the Chiltern Hills, our campsite offers a quiet escape with beautiful hillside views.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Suffolk Coast Spot", category_id=2, campsite_longitude=1.6000, campsite_latitude=52.0500, parking_cost=12, facilities_cost=24,
                     description="Enjoy the sandy shores and gentle tides of the Suffolk Coast from our peaceful campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Exmoor Expanse", category_id=3, campsite_longitude=-3.5550, campsite_latitude=51.1200, parking_cost=16, facilities_cost=32,
                     description="Explore the vast landscapes of Exmoor with wild ponies and starry nights at our campsite.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Scottish Highlands Haven", category_id=4, campsite_longitude=-4.2425, campsite_latitude=57.4789, parking_cost=18, facilities_cost=36,
                     description="Our campsite in the Scottish Highlands offers an unrivaled escape into nature.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Anglesey Island Retreat", category_id=5, campsite_longitude=-4.2900, campsite_latitude=53.2800, parking_cost=11, facilities_cost=23,
                     description="Discover the coastal beauty of Anglesey at our exclusive island retreat.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="A Quiet Spot in the Glen", category_id=1, campsite_longitude=-3.5467, campsite_latitude=56.4907, parking_cost=0, facilities_cost=0,
                     description="A discreet nook beside a gentle stream in a secluded glen. Ideal for those who seek solitude.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Just a Flat Bit by the Side of a Road", category_id=2, campsite_longitude=-4.2420, campsite_latitude=57.4780, parking_cost=0, facilities_cost=0,
                     description="Literally just a flat area next to a rural road. No amenities, but free and easy to reach.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Hidden Pine Patch", category_id=3, campsite_longitude=-2.9630, campsite_latitude=54.8970, parking_cost=0, facilities_cost=0,
                     description="A small clearing surrounded by pine trees. Quiet and somewhat isolated, suitable for a quick stop.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Old Quarry Outskirts", category_id=4, campsite_longitude=-2.9850, campsite_latitude=53.3470, parking_cost=0, facilities_cost=0,
                     description="An abandoned quarry's outskirts, offering a rough but scenic setting for an overnight stay.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Riverside Gravel Lot", category_id=5, campsite_longitude=-3.1850, campsite_latitude=54.1120, parking_cost=0, facilities_cost=0,
                     description="A gravel lot beside a small river. Popular with fishermen, though facilities are non-existent.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Moorland Roadside", category_id=1, campsite_longitude=-3.7740, campsite_latitude=50.7370, parking_cost=0, facilities_cost=0,
                     description="A spot on the edge of the moor, accessible directly from the road. Windy and open, with no shelter.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Forest Edge Layby", category_id=2, campsite_longitude=-2.3770, campsite_latitude=52.3660, parking_cost=0, facilities_cost=0,
                     description="A layby at the edge of a forest. Convenient for a night's stay but expect some road noise.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Hilltop Breeze Spot", category_id=3, campsite_longitude=-1.8950, campsite_latitude=53.9560, parking_cost=0, facilities_cost=0,
                     description="An exposed hilltop area known for its strong breezes. Not much around, but the view is decent.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Country Road Corner", category_id=4, campsite_longitude=-4.0750, campsite_latitude=50.3750, parking_cost=0, facilities_cost=0,
                     description="A quiet corner off a seldom-traveled country road. No amenities, but peaceful.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Field Gate Gathering", category_id=5, campsite_longitude=-2.9750, campsite_latitude=53.8250, parking_cost=0, facilities_cost=0,
                     description="A grassy area by a field gate, popular among local campers. Basic and unregulated.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Woodsy Hollow", category_id=1, campsite_longitude=-3.3450, campsite_latitude=55.9250, parking_cost=0, facilities_cost=0,
                     description="A hollow in the woods offering some shelter from the elements. Quiet, but dark at night.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Streamside Soft Spot", category_id=2, campsite_longitude=-3.6670, campsite_latitude=56.5670, parking_cost=0, facilities_cost=0,
                     description="A soft ground spot near a stream. Naturally beautiful, though can be damp.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Under the Bridge Bypass", category_id=3, campsite_longitude=-1.4760, campsite_latitude=52.9540, parking_cost=0, facilities_cost=0,
                     description="A small area under a bridge, offering shelter and a bit of road noise.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Mountain View Pull-Off", category_id=4, campsite_longitude=-3.0001, campsite_latitude=53.1000, parking_cost=0, facilities_cost=0,
                     description="A roadside pull-off with a view of the mountains. Exposed and minimal, best for self-sufficient campers.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Village End Road", category_id=5, campsite_longitude=-2.9810, campsite_latitude=51.8910, parking_cost=0, facilities_cost=0,
                     description="The end of a village road turns into a casual camping spot. Local interaction likely.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Canal Path Clearing", category_id=1, campsite_longitude=-1.8750, campsite_latitude=52.4860, parking_cost=0, facilities_cost=0,
                     description="A clearing along a canal path. Popular with cyclists and walkers, fairly quiet at night.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Backroad Brush", category_id=2, campsite_longitude=-4.2750, campsite_latitude=57.2730, parking_cost=0, facilities_cost=0,
                     description="A small brush-lined spot off a backroad. Secluded but may have occasional traffic.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Farmer's Field Fringe", category_id=3, campsite_longitude=-2.0450, campsite_latitude=53.3470, parking_cost=0, facilities_cost=0,
                     description="The fringe of a farmer's field, often unused but accessible. Basic and rural.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Countryside Cul-de-Sac", category_id=4, campsite_longitude=-3.5470, campsite_latitude=50.7190, parking_cost=0, facilities_cost=0,
                     description="A dead-end road in the countryside that's become a makeshift campsite. Quiet and distant.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Beside the Barn", category_id=5, campsite_longitude=-1.8590, campsite_latitude=52.9220, parking_cost=0, facilities_cost=0,
                     description="Next to an old barn, this spot offers rustic charm but little comfort.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Meadow's Edge", category_id=1, campsite_longitude=-4.0250, campsite_latitude=51.3450, parking_cost=0, facilities_cost=0,
                     description="The edge of a meadow, frequently visited by deer. Picturesque but lacks facilities.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Pasture Pathway", category_id=2, campsite_longitude=-3.6500, campsite_latitude=50.4500, parking_cost=0, facilities_cost=0,
                     description="A pathway through a pasture that's open for camping. Watch out for livestock.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Edge of Nowhere", category_id=3, campsite_longitude=-3.9800, campsite_latitude=56.4900, parking_cost=0, facilities_cost=0,
                     description="As remote as it gets, on the edge of nowhere. For those who truly want to disconnect.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Old Mill Site", category_id=4, campsite_longitude=-2.1100, campsite_latitude=57.1490, parking_cost=0, facilities_cost=0,
                     description="The site of an old mill, mostly overgrown but with a certain historical appeal.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Rural Route Rest", category_id=5, campsite_longitude=-3.3200, campsite_latitude=54.4800, parking_cost=0, facilities_cost=0,
                     description="A rest spot along a rural route, known only to locals. Simple and straightforward.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Heathland Hideout", category_id=1, campsite_longitude=-0.9530, campsite_latitude=51.3030, parking_cost=0, facilities_cost=0,
                     description="A hideout in the heathlands, often missed by the unobservant. Wild and untouched.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Lakeside Ledge", category_id=2, campsite_longitude=-2.8830, campsite_latitude=54.3330, parking_cost=0, facilities_cost=0,
                     description="A narrow ledge by a lake, scenic but cramped. Suitable for the solitary camper.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Field Corner Camp", category_id=3, campsite_longitude=-2.9820, campsite_latitude=53.4820, parking_cost=0, facilities_cost=0,
                     description="A quiet corner of a field, often used by passersby. No amenities, very basic.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Woodland Walkway", category_id=4, campsite_longitude=-3.8720, campsite_latitude=51.6720, parking_cost=0, facilities_cost=0,
                     description="A walkway through dense woodland, sometimes used for camping. Dark and quiet.", date_added=date_stamp(), user_account_id=1, approved=True),
            Campsite(campsite_name="Trailside Tent Site", category_id=5, campsite_longitude=-4.1720, campsite_latitude=57.2920, parking_cost=0, facilities_cost=0,
                     description="A simple tent site beside a trail, used by hikers. Minimalist and natural.", date_added=date_stamp(), user_account_id=1, approved=True),
        ],
        'campsite_photo': [
            CampsitePhoto(
        ...
        'users_credentials': [
            ...
            User_Credentials(username="VigorousCamel"),
            User_Credentials(username="MeadowSinger"),
            User_Credentials(username="CampfireStoryteller"),
            User_Credentials(username="TrailBlazer"),
            User_Credentials(username="LakesideLounger")
        ],
        'user_accounts': [
            User_Account(user_id=1, user_firstname="All of", user_lastname="Us",
                         user_email="admin@example.com", xp=999, user_type="ADMIN", camera_permission=True),
            User_Account(user_id=2, user_firstname="Alice", user_lastname="Wanderlust",
                         user_email="alice@example.com", xp=500, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=3, user_firstname="Bob", user_lastname="Hills",
                         user_email="bob92@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=4, user_firstname="Clara", user_lastname="Greenwood",
                         user_email="clara.fanatic@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=5, user_firstname="Dan", user_lastname="Rivers",
                         user_email="dan.raider@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=6, user_firstname="Eva", user_lastname="Song",
                         user_email="eva.singer@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=7, user_firstname="Frank", user_lastname="Tales",
                         user_email="frank.tales@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=8, user_firstname="Grace", user_lastname="Pathfinder",
                         user_email="grace.blazer@example.com", xp=0, user_type="NORMAL", camera_permission=True),
            User_Account(user_id=9, user_firstname="Harry", user_lastname="Waters",
