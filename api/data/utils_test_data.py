...
from api.models.campsite_models import Campsite, CampsiteContact, CampsitePhoto, CampsiteCategory
...
def get_complete_seed_test_data():
    return {
        ...
        'campsite_photo': [
            CampsitePhoto(
                campsite_id=1, campsite_photo_url="https://example.com/photo1.jpg"),
            CampsitePhoto(
                campsite_id=2, campsite_photo_url="https://example.com/photo2.jpg"),
            CampsitePhoto(
                campsite_id=3, campsite_photo_url="https://example.com/photo3.jpg")
        ],
        'campsite_contact': [
            CampsiteContact(campsite_contact_id=1, campsite_id=1,
                            campsite_contact_name="John Doe", campsite_contact_phone="123-456-7890"),
            CampsiteContact(campsite_contact_id=2, campsite_id=2,
                            campsite_contact_name="Jane Doe", campsite_contact_phone="987-654-3210"),
            CampsiteContact(campsite_contact_id=3, campsite_id=3,
